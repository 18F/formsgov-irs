...
import static gov.gsa.forms.test.util.OAuth2TestUtil.TEST_USER_LOGIN;
import static gov.gsa.forms.test.util.OAuth2TestUtil.registerAuthenticationToken;
import static gov.gsa.forms.test.util.OAuth2TestUtil.testAuthenticationToken;
import static org.springframework.test.web.servlet.request.MockMvcRequestBuilders.get;
import static org.springframework.test.web.servlet.result.MockMvcResultMatchers.*;

import gov.gsa.forms.IntegrationTest;
import gov.gsa.forms.security.AuthoritiesConstants;
